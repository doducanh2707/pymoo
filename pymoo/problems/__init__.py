...
def get_problem(name,network = None,requests = None,network_name= None, *args, **kwargs):
    name = name.lower()
    ...
    from pymoo.problems.nfv.nfv import NFV,NFV_GP
    PROBLEM = {
        'ackley': Ackley,
        'bnh': BNH,
        'carside': Carside,
    ...
    if name == "nfv_gp":
        return NFV_GP(network,requests,network_name)
